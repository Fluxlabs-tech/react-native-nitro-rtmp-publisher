...
/**
 * Wraps a Swift `(_ bitrate: Double) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_double {
  public typealias bridge = margelo.nitro.rtmppublisher.bridge.swift

  private let closure: (_ bitrate: Double) -> Void

  public init(_ closure: @escaping (_ bitrate: Double) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(bitrate: Double) -> Void {
    self.closure(bitrate)
  }
