...
/**
 * Wraps a Swift `(_ isInPip: Bool) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_bool {
  public typealias bridge = margelo.nitro.rtmppublisher.bridge.swift

  private let closure: (_ isInPip: Bool) -> Void

  public init(_ closure: @escaping (_ isInPip: Bool) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(isInPip: Bool) -> Void {
    self.closure(isInPip)
  }
