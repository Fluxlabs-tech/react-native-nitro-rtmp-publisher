...
/**
 * Wraps a Swift `(_ bitrateBps: Double, _ videoFps: Double) -> Void` as a class.
...
public final class Func_void_double_double {
  ...
  private let closure: (_ bitrateBps: Double, _ videoFps: Double) -> Void

  public init(_ closure: @escaping (_ bitrateBps: Double, _ videoFps: Double) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(bitrateBps: Double, videoFps: Double) -> Void {
    self.closure(bitrateBps, videoFps)
  }
