...
namespace margelo::nitro::rtmppublisher {
  ...
  class HybridRtmpPublisherViewSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual void setBeautyParams(double temperature, double saturation, double skinLift) = 0;
      ...
      virtual void setOnAudioDriftCorrection(const std::function<void(double /* correctionMs */, double /* totalCorrectionMs */)>& callback) = 0;
      virtual void injectAudioDesyncForTesting(double ms) = 0;
