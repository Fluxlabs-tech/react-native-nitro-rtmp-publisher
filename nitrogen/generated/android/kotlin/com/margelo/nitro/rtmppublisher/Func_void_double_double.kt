...
/**
 * Represents the JavaScript callback `(bitrateBps: number, videoFps: number) => void`.
...
fun interface Func_void_double_double: (Double, Double) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(bitrateBps: Double, videoFps: Double): Unit
}
...
class Func_void_double_double_cxx: Func_void_double_double {
  ...
  @Keep
  override fun invoke(bitrateBps: Double, videoFps: Double): Unit
    = invoke_cxx(bitrateBps,videoFps)

  @FastNative
  private external fun invoke_cxx(bitrateBps: Double, videoFps: Double): Unit
}
...
class Func_void_double_double_java(private val function: (Double, Double) -> Unit): Func_void_double_double {
  ...
  @Keep
  override fun invoke(bitrateBps: Double, videoFps: Double): Unit {
    return this.function(bitrateBps, videoFps)
  }
}
